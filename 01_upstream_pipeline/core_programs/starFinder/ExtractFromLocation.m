function [allReads, allSpots, allScores, csMat] = ExtractFromLocation( input_img, allSpots, voxelSize, q_score_thers, interm_outpath, showPlots, obj_log )
%ExtractFromLocation
